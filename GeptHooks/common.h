...
//(GeptHookRemove的DPC: rdx=GPA r8=hide); 13=私有CR3树protect
//(v1.12: rdx=VA r8=len, root深拷贝/sync该区间, 见Cr3.c)
#define GEPT_VMCALL_MSRBIT 8
#define GEPT_VMCALL_TSCCAL 10
#define GEPT_VMCALL_CLKARM 11
#define GEPT_VMCALL_CPHIDE 12
#define GEPT_VMCALL_PTPROT 13
...
#define GEPT_EXIT_REASON_MAX 82
	...
	//  K=私有CR3树protect(vmcall13: a=VA b=len c=1成功/0 fallback共享)
	...
	//  g=时钟慢路径flicker(rsn=48 a=gpa b=rip c=1影子补偿/0真值降级 /
	//    rsn=30 a=端口, 采样; v1.12a起MMIO慢路径统一影子flicker=
	//    读补偿/store写回, 端口串仍为逐迭代放行)
