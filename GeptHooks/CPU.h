...
enum
{
	...
	//(VMFUNC EPTP switching): VMCS 64-bit control字段编码
	...
	//注意: VMCS字段编码**必须查权威源**, 凭记忆写错(如把VM_FUNCTION_
	//CONTROL写成0x2015=APIC-access高半区)→字段被硬件忽略→vmfunc执行
	//=unsupported function=#UD(guest内直接异常)→蓝屏
